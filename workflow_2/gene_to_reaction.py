...
def workflow(fasta_file, intermediate_files_dir, cpu_count,
    ...
    start = time.time()
    gene_blast = blast.multi_blast(genome.index, genome, my_settings.refseq_db, 
    ...
    gene_blast.to_csv(os.path.join(intermediate_files_dir, 'gene_blast.csv'))
    ...
    gene_to_reaction_top.to_csv(gene_to_reaction_top_path)
